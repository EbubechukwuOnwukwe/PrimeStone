...
/**
 * CorporateFinanceBanking page component.
 * Focuses on lending, project finance, fintech, and capital markets expertise.
 */
const CorporateFinanceBanking = () => {

  const [isSending, setIsSending] = useState(false);
  // State for inquiry dropdown logic
    ...
    <section>
           <div className="md:relative bg-[#1A242F] h-130 w-full py-10 px-0 text-center md:h-170 md:py-0 flex flex-col justify-center items-center xl:items-start overflow-hidden">    
                  ...
                  <h1 className="md:relative md:z-10 text-center mt-10 text-5xl font-serif font-semibold text-[#F9F7F2]  xl:text-left xl:ml-20">
                    <span className="lg:text-6xl xl:text-7xl">CORPORATE FINANCE <br className="hidden xl:block"/> & BANKING</span>
                    <p className="text-3xl my-6 xl:w-[73%] hidden md:block md:px-4 xl:px-0 xl:ml-1">Sophisticated legal structuring for capital markets, lending, and fintech innovations.</p>
                  </h1>
                </div>
        </section>

        {/* Detailed Expertise and Request Form */}
        <section className="my-7 xl:flex xl:gap-5 xl:my-10 xl:items-stretch xl:w-[98%] xl:m-auto">
        <div className="xl:flex-1">
          <h1 className="text-center text-[34.5px] font-bold lg:text-[52px] xl:text-left xl:ml-4">OUR CORPORATE FINANCE & BANKING EXPERTISE</h1>
          <div className="w-[95%] m-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-5 xl:block">
            <div className="my-6 flex font-semibold">
              <FaBuildingColumns className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Syndicated <br />Lending</p>
            </div>
            <div className="my-6 flex font-semibold">
              <MdOutlineConstruction className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Project <br />Finance</p>
            </div>
            <div className="my-6 flex font-semibold">
              <AiOutlineSafetyCertificate className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Asset-Backed <br />Securities</p>
            </div>
            <div className="my-6 flex font-semibold">
              <TbBinaryTree className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">FinTech & <br />Digital Assets</p>
            </div>
            <div className="my-6 flex font-semibold">
              <VscGraphLine className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Capital <br />Markets</p>
            </div>
          </div>
        </div>
          <form 
          ...
          >
            ...
            <div className="relative w-full my-2">
              ...
              >
                ...
                <option value="Syndicated Lending">Syndicated Lending</option>
                <option value="Project Finance">Project Finance</option>
                <option value="Asset-Backed Securities">Asset-Backed Securities</option>
...
export default CorporateFinanceBanking