...
import { FaChevronDown, FaCoins, FaMedal } from 'react-icons/fa';
import { FaGavel, FaHandHoldingDollar, FaUserShield } from 'react-icons/fa6';
...
/**
 * LitigationDisputeResolution page component.
 * Displays expertise in litigation, arbitration, and debt recovery,
 * and provides a tailored consultation request form.
 */
const LitigationDisputeResolution = () => {
  
  const [isSending, setIsSending] = useState(false);
  // State to handle conditional rendering of the "Other" service input field
    ...
    <section>
           <div className="md:relative bg-[#1A242F] h-130 w-full py-10 px-0 text-center md:h-170 md:py-0 flex flex-col justify-center items-center xl:items-start overflow-hidden">    
                  ...
                  <h1 className="md:relative md:z-10 text-center mt-10 text-5xl font-serif font-semibold text-[#F9F7F2]  xl:text-left xl:ml-20">
                    <span className="lg:text-6xl xl:text-7xl">LITIGATION & <br className="hidden xl:block"/> DISPUTE RESOLUTION</span>
                    <p className="text-3xl my-6 xl:w-[73%] hidden md:block md:px-4 xl:px-0 xl:ml-1">Rigorous advocacy and strategic resolution to protect your interests in every forum.</p>
                  </h1>
                </div>
        </section>
        ...
        <div className="xl:flex-1">
          <h1 className="text-center text-[34.5px] font-bold lg:text-[52px] xl:text-left xl:ml-4">OUR LITIGATION & DISPUTE RESOLUTION EXPERTISE</h1>
          <div className="w-[95%] m-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-5 xl:block">
            <div className="my-6 flex font-semibold">
              <FaGavel className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Commercial <br />Litigation</p>
            </div>
            <div className="my-6 flex font-semibold">
              <BiConversation className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Arbitration & <br className="hidden xl:block"/>Mediation</p>
            </div>
            <div className="my-6 flex font-semibold">
              <FaHandHoldingDollar className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Debt <br />Recovery</p>
            </div>
            <div className="my-6 flex font-semibold">
              <MdOutlineWorkHistory className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Employment <br />Disputes</p>
            </div>
            <div className="my-6 flex font-semibold">
              <RiParentLine className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Family <br />Law</p>
            </div>
          </div>
        </div>
          <form 
