...
import { FaMapMarkedAlt, FaChevronDown, FaCoins, FaMedal } from 'react-icons/fa';
import { HiOutlineHomeModern, HiOutlineKey } from 'react-icons/hi2';
...
/**
 * RealEstateConstruction page component.
 * Covers property acquisition, construction law, and REITs.
 */
const RealEstateConstruction = () => {

  const [isSending, setIsSending] = useState(false);
  // State for inquiry form dropdown logic
  ...
  return (
    ...
    <section>
               <div className="md:relative bg-[#1A242F] h-130 w-full py-10 px-0 text-center md:h-170 md:py-0 flex flex-col justify-center items-center xl:items-start overflow-hidden">    
                      ...
                      <h1 className="md:relative md:z-10 text-center mt-10 text-[46px] font-serif font-semibold text-[#F9F7F2]  xl:text-left xl:ml-20">
                        <span className="lg:text-6xl xl:text-7xl">REAL ESTATE & <br className="hidden xl:block"/> CONSTRUCTION</span>
                        <p className="text-3xl my-6 xl:w-[73%] hidden md:block md:px-4 xl:px-0 xl:ml-1">Securing high-value infrastructure through expert property law and finance.</p>
                      </h1>
                    </div>
            </section>

            {/* Main Content: List of Services and Form */}
            <section className="my-7 xl:flex xl:gap-5 xl:my-10 xl:items-stretch xl:w-[98%] xl:m-auto">
        <div className="xl:flex-1">
          <h1 className="text-center text-[34.5px] font-bold lg:text-[52px] xl:text-left xl:ml-4">OUR REAL ESTATE & CONSTRUCTION EXPERTISE</h1>
          <div className="w-[95%] m-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-5 xl:block">
            <div className="my-6 flex font-semibold">
              <HiOutlineHomeModern className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Property Acquisition <br />& Disposal</p>
            </div>
            <div className="my-6 flex font-semibold">
              <LuHardHat className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Construction <br />Law</p>
            </div>
            <div className="my-6 flex font-semibold">
              <BsHouseUp className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Real Estate <br />Investment Trusts</p>
            </div>
            <div className="my-6 flex font-semibold">
              <FaMapMarkedAlt className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Planning <br />& Land Use</p>
            </div>
            <div className="my-6 flex font-semibold">
              <HiOutlineKey className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Property <span className="text-[28px] lg:text-[35px]">Management</span> <br />& Leasing</p>
            </div>
          </div>
        </div>
          <form 
          ...
          >
            ...
            <div className="relative w-full my-2">
              ...
              >
                ...
                <option value="Property Acquisition & Disposal">Property Acquisition & Disposal</option>
                ...
                <option value="Property Management & Leasing">Property Management & Leasing</option>
