...
import { FaRegCopyright, FaUserCheck } from 'react-icons/fa6';
import { MdOutlineStar, MdOutlineMovieFilter, MdOutlineConfirmationNumber } from 'react-icons/md';
import { useState, useEffect } from 'react';
import { Link } from "react-router-dom";
import Cookies from 'js-cookie';

/**
 * EntertainmentSports page component.
 * Provides information on legal services for the entertainment and sports industries,
 * including IP protection and talent contracts.
 */
const EntertainmentSports = () => {

  const [isSending, setIsSending] = useState(false);
  // State to manage the visibility of the "Other" service input field in the form
  ...
  return (
    ...
    <section>
           <div className="md:relative bg-[#1A242F] h-130 w-full py-10 px-0 text-center md:h-170 md:py-0 flex flex-col justify-center items-center xl:items-start overflow-hidden">    
                  ...
                  <h1 className="md:relative md:z-10 text-center mt-10 text-[42px] font-serif font-semibold text-[#F9F7F2]  xl:text-left xl:ml-20">
                    <span className="lg:text-6xl xl:text-7xl">ENTERTAINMENT <br className="hidden xl:block"/> & SPORTS</span>
                    <p className="text-3xl my-6 xl:w-[73%] hidden md:block md:px-4 xl:px-0 xl:ml-1">Protecting creative assets and athletic talent through robust intellectual property and brand management.</p>
                  </h1>
                </div>
        </section>

        {/* Expertise and Contact Form Section */}
        <section className="my-7 xl:flex xl:gap-5 xl:my-10 xl:items-stretch xl:w-[98%] xl:m-auto">
        <div className="xl:flex-1">
          <h1 className="text-center text-[34.5px] font-bold lg:text-[52px] xl:text-left xl:ml-4">OUR ENTERTAINMENT <br className="lg:hidden"/>& SPORTS EXPERTISE</h1>
          <div className="w-[95%] m-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-5 xl:block">
            <div className="my-6 flex font-semibold">
              <FaRegCopyright className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Intellectual Property <br />Protection</p>
            </div>
            <div className="my-6 flex font-semibold">
              <MdOutlineStar className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Talent & Endorsement <br />Contracts</p>
            </div>
            <div className="my-6 flex font-semibold">
              <MdOutlineMovieFilter className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Media Rights <br />& Distribution</p>
            </div>
            <div className="my-6 flex font-semibold">
              <FaUserCheck className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Image Rights <br />& Branding</p>
            </div>
            <div className="my-6 flex font-semibold">
              <MdOutlineConfirmationNumber className="text-[75px] text-[#C5A059] bg-[#1A242F] p-4 rounded-2xl lg:text-8xl"/>
              <p className="text-3xl mx-2 lg:text-4xl lg:mt-1 xl:mt-2.25">Sponsorship & <br />Event Management</p>
            </div>
          </div>
        </div>
          <form 
          ...
          >
            ...
            <div className="relative w-full my-2">
              ...
              >
                ...
                <option value="Talent & Endorsement Contracts">Talent & Endorsement Contracts</option>
                <option value="Media Rights & Distribution">Media Rights & Distribution</option>
                <option value="Image Rights & Branding">Image Rights & Branding</option>
                <option value="Sponsorship & Event Management">Sponsorship & Event Management</option>
      ...
      {/* Navigation to other Practice Areas */}
      <section className="p-5 bg-[#C5A059] mb-0">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-5 xl:grid-cols-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" 
            ...
            <p>Corporate <br className="hidden xl:block"/>& <br className="hidden lg:block"/>Commercial</p>
            <Link to="/CorporateCommercial" className="text-[28px] mt-3 justify-center items-center flex text-[#C5A059] hover:text-[#9D7F45]">
                View
                <svg xmlns="http://www.w3.org/2000/svg" 
                  viewBox="0 0 24 24" 
                  fill="currentColor" 
